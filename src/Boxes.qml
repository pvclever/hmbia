...
Item {
    ...
    Component.onCompleted: {
      lst = [];
      var firstbox = createNewCh(0, new BSelectorData.RoundState(new BSelectorData.RStateItem(16,0), new BSelectorData.RStateItem(0,0)));
    ...
    function createNewCh(round, prev_state) {
       ...
       console.log(JSON.stringify(prev_state));
